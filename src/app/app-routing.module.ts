...
export const routes: Routes = [
  ...
  },
  {
    ...
    data: { id: '4', notSecure: true },
  },
  {
    path: 'reset',
    component: ResetComponent,
    data: { id: '5', title: 'إعادة الضبط' },
  },
  {
    path: 'reset/message',
...

  {
    ...
    data: {
      ...
      data: {
        entities: [
          { role: 'agency', entity: 'agency/agents', pagination: true },
          { role: 'admin', entity: 'users', pagination: true },
        ],
      },
    }, // Données spécifiques pour cette sous-route
  },
  {
    path: 'notifications',
    component: WrapperComponent,
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          id: '12-2',
          title: 'إضافة الوكلاء',
          roles: ['super_admin', 'admin', 'agency'],
        },
      },
      {
        path: 'edit/:id',
  ...
  },
  {
    ...
    data: {
      id: '14',
      title: 'الوكالة',
      roles: ['super_admin', 'agent', 'agency'],
    },
  },
  {
    path: 'agencies',
...

  {
    ...
    data: {
      ...
      data: {
        entities: [
          { role: 'agency', entity: 'account', pageSize: 0, pagination: false },
        ],
      },
    },
  },
...

  {
    ...
    data: {
      ...
      data: {
        entities: [
          { role: 'agency', entity: 'get-snap-data' },
          { role: 'super_admin', entity: 'get-snap-data' },
        ],
      },
      roles: ['super_admin', 'agent', 'agency'],
    },
